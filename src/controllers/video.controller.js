...
const publishAVideo = asyncHandler(async (req, res) => {
  ...
  //      }
  // console.log("thumbNailPath h ki nhui ", thumbNailPath)
...
console.log("video resposne from controller",video)
  if (!thumbNail) {
...
const deleteVideo = asyncHandler(async (req, res) => {
  console.log("inside of the delete function")
  const { videoId } = req.params
  const video = await Video.findById({ _id: videoId })
  console.log("yhi h woo video",video)
  ...
  const videoById = video.videoFile?.public_id
  console.log("video mil gya h ",videoById)
  const thumbNailById = video.thumbnail?.public_id
  console.log("thumbnail mil gya h -" , thumbNailById)

  const deletedVideo = await Video.findByIdAndDelete(videoId)
  console.log("video delete ho rha h DB se" ,deletedVideo)
